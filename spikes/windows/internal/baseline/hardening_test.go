...
func TestEventProvenanceRejectsUnrelatedAndDuplicateEvents(t *testing.T) {
	...
	e := TraceEvent{PID: 20, EventID: "event-1", Sequence: 1, TimestampUTC: "2026-07-22T12:00:01Z", RunNonce: "n", AttemptID: "n/x", Operation: "CreateFile", Result: "DENIED", Path: "x.dll"}
